...
class RuleMatchingTests(unittest.TestCase):
    def test_criteria_match_expected_message(self) -> None:
        ...
        self.assertTrue(criteria.matches(message_data))

    def test_any_match_mode_accepts_partial_match(self) -> None:
        message = EmailMessage()
