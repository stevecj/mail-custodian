...
As of this writing, except for the text in this section, and the
.gitignore and LICENSE.md files, everything in this project was
generated by prompting an AI model. The code is not guaranteed to be
correct or secure, and you should review it carefully before using it
in production. If you find any issues, please report them.
